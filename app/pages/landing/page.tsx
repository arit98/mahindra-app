...
export default function LandingPage() {
  ...
  const floorPlans = [
    {
      type: "MASTER PLAN",
      image:
        "/assets/images/floor/e6ead2c6a6eaeeb7cf4bb2cc67c2820d8881c16d.png",
      isSoldOut: false,
    },
    {
      type: "2 BHK",
      image:
        "/assets/images/floor/69c1c9e6161ebf4d1bd9936e8a73f3769feead0a.png",
      isSoldOut: true,
    },
    {
      type: "2 BHK (Large)",
  ...
  const images = {
    aromaticGarden:
      "/assets/images/gal/d4df73e0bb5607d02bd8e614a728cae70df00696.png",
    spaciousKitchen:
      "/assets/images/gal/a34c3d67c3b760deeb5890999efccceb361d7155.jpg",
    partyLawn:
      "/assets/images/gal/d55e031fb938267c3cfa8e57281ecbcc1241f835.jpg",
    multipurposeCourt:
      "/assets/images/gal/b3313b666d29c044ab6b708c27667ae975ebf7da.jpg",
    modernBedroom:
      "/assets/images/gal/6550e6b4a3afe9337004a5de39e085f24f34278e.jpg",
    gym: "/assets/images/gal/2999d463e2f8a092c45763ddc24730d3ce89ff17.png",
    cricketNets:
      "/assets/images/gal/148dd6b6be1dd668adda0f3bf161bea79aa0222d.jpg",
    olympicPool:
      "/assets/images/gal/b52bd7eac260fe7d93e5bbf28320916dece154ac.jpg",
    landscapedGardens:
      "/assets/images/gal/94ef86ebcf8bb751e374b8c2c0142e5e3b2d21a9.png",
    ventilatedFlats:
      "/assets/images/gal/a50579942cd02462603a3ef2f677ceaf72d1f76e.jpg",
    largeBalcony:
      "/assets/images/gal/01f06dd93195733a6bf18c52e5ab013336cd8186 (2).jpg",
    joggingTrack:
      "/assets/images/gal/b3b5980a1a244fe6c4d548fd8edfdb43d056a29a.png",
  };
  ...
  const specifications = [
    ...
    },
    {
      ...
      items: ["Chromium Plated Fittings of reputed make."],
    },
    {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white overflow-x-hidden selection:bg-red-500/30 flex flex-col">
      ...
      <section className="relative min-h-screen md:hidden lg:hidden flex flex-col items-center pt-24 pb-12 overflow-hidden">
        <MobHeroBackground
          image1Src="/assets/images/hero.png"
          image2Src="/assets/images/tree.png"
        />
      ...
      <section
        id="home"
        className="relative min-h-screen hidden md:flex lg:flex items-center pt-24 pb-12 overflow-hidden"
      >
      ...
      <section
        id="pricing"
        className="w-full bg-primary py-12 lg:py-20 px-4 md:px-28"
      >
        <div className="container mx-auto flex flex-col items-center space-y-8">
          <div className="font-serif text-2xl md:text-4xl lg:text-5xl md:text-center text-start space-y-2">
            ...
            <p className="text-[9px] md:text-base font-sans italic text-white/80 md:text-center text-end uppercase">
      ...
      <section id="amenities" className="py-20 bg-slate-100">
        <div className="container mx-auto px-4 text-start md:text-center">
          <h2 className="text-2xl md:text-5xl font-serif mb-4 text-[#4B4D4C]">
            <span className="text-red-500">Amenities</span> for Every Age, Every
            Mood
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto italic md:text-center text-end md:text-base text-[9px] uppercase">
      ...
      <section
        id="floor-plans"
        className="bg-primary py-24 px-4 overflow-hidden"
      >
        <div className="container mx-auto max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-2xl md:text-6xl font-serif text-white md:text-center text-start">
      ...
      <section className="w-full bg-slate-50 py-8 overflow-hidden">
        <div className="text-center space-y-4 mb-4">
          <div className="px-4 flex flex-col gap-4">
            <h2 className="text-2xl md:text-6xl font-serif text-slate-900 md:text-center text-start">
              A <span className="text-primary">Glimpse</span> of Life at
              Mahindra Blossom
            </h2>
      ...
      <section
        id="specifications"
        className="hidden md:hidden lg:flex py-24 bg-white overflow-hidden"
      >
        <div className="container mx-auto px-2">
          <div className="text-center space-y-4 mb-8">
            <h2 className="text-5xl md:text-6xl font-serif text-[#4B4D4C]">
              Smart <span className="text-primary">Specifications</span>
            </h2>
      ...
      <section className="py-16 md:py-24 bg-white overflow-hidden md:px-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <Location features={featureLocation} />
          </div>
        </div>
      </section>
