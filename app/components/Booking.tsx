        ...
        <div className="relative w-full md:w-[48%] p-6 md:p-12 flex flex-col justify-start md:justify-center min-h-[140px] md:min-h-0">
          ...
          <div className="absolute top-12 md:top-auto md:bottom-8 left-0 w-full h-[35%] md:h-[50%] opacity-30 pointer-events-none select-none">
            <Image
              ...
              alt=''
              fill
              className="object-contain object-top md:object-bottom-left scale-450 md:scale-130"
              priority
            />
          </div>

          <div className="relative z-10 md:-mt-48 mt-8 text-center md:text-left">
            <p className="text-[#9CA3AF] uppercase tracking-[0.3em] text-[10px] md:text-sm font-semibold italic mb-3 md:mb-6">
              Let us show you around
            </p>
            <h2 className="text-2xl md:text-6xl lg:text-7xl font-serif text-[#374151] leading-[1.1] tracking-tight px-2 md:px-0">
          ...
          <form className="space-y-4 md:space-y-7 text-slate-900" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1 md:space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 md:px-5 md:py-4 rounded-xl border border-gray-200 bg-gray-50/40 focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all placeholder:text-gray-400 font-medium"
              />
            </div>
            ...
            <div className="space-y-1 md:space-y-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 md:px-5 md:py-4 rounded-xl border border-gray-200 bg-gray-50/40 focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all placeholder:text-gray-400 font-medium resize-none"
              ></textarea>
            </div>
