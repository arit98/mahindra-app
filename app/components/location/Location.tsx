...
const Location: React.FC<LocationProps> = ({ features }) => {
  const [isZoomed, setIsZoomed] = useState(false);

  return (
    <>
      <div
        className="relative group cursor-zoom-in w-full order-2 md:col-span-1"
          ...
          <div className="relative w-full max-w-[300px] md:max-w-[400px] flex items-center">
            <div className="px-4">
              <Image
                ...
                width={600}
                height={24}
                className="opacity-90 w-full max-w-[280px] md:max-w-[500px] md:scale-130"
              />
            </div>
          </div>
        </div>
